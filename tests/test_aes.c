...
static void test_case_aes_256(void)
{
    ...
    uint8_t data_decrypt_out[220] = {1};
    ...
    result = dsec_aes_decrypt(data_decrypt_out,
    ...
    DSEC_TEST_ASSERT(data_decrypt_out_size == data_in_size);

    DSEC_TEST_ASSERT(memcmp(data_in,
                            data_decrypt_out,
...
static void test_case_aes_256_big_buffer(void)
{
    ...
    uint8_t data_decrypt_out[MAX_UDP_BUFFER_BYTES] = {1};
    uint32_t data_decrypt_out_size = MAX_UDP_BUFFER_BYTES;
...
static void test_case_aes_128(void)
{
    ...
    uint8_t data_decrypt_out[100] = {1};
    uint32_t data_decrypt_out_size = sizeof(data_decrypt_out);
...
static void test_case_aes_decrypt_bad_parameters(void)
{
    int32_t result = 0;
    ...
    /* Zero-sized initialization vector */
    result = dsec_aes_decrypt(data_decrypt_out,
                              &data_decrypt_out_size,
                              &instance,
                              tag,
...
static const struct dsec_test_case_desc test_case_table[] = {
    ...
    DSEC_TEST_CASE(test_case_aes_decrypt_bad_parameters),
};
